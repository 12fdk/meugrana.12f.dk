...
const translations = {
  pt: {
    ...
    'hero.authority': 'Não é estimativa: é o cálculo exato do fechamento do seu cartão.',
    'hero.stakes': 'A parcela que você esqueceu já está na fatura do mês que vem.',
    'hero.microcopy': 'Grátis para baixar · Sem cadastro · A gente não conecta no seu banco',
    'hero.transitional': 'Ainda decidindo? Veja quanto custa parcelar →',
    ...
    'how.subtitle': 'Da primeira parcela ao controle total em três passos.',
    'how.step1.title': 'Cadastre uma parcela',
    'how.step1.desc': 'Loja, valor e em quantas vezes. O cartão você cria na hora, ali mesmo — sem formulário separado.',
    'how.step2.title': 'Veja a projeção das próximas faturas',
    'how.step2.desc': 'Saiba hoje quanto vai pagar nos próximos 12 meses, com cada parcela já contabilizada.',
    'how.step3.title': 'Receba o aviso antes do mês pesado',
    'how.step3.desc': 'Fechamento, vencimento e parcela pesada chegando: o MeuGrana avisa antes, não depois.',
    ...
    'pricing.premium.price': 'Pagamento único de R$ 29,90',
    ...
    'faq.q13.a': 'Existe. Quando você cadastra sua primeira parcela ou seu primeiro cartão, começam 7 dias de Premium liberado — sem cartão de crédito, sem cobrança e sem renovação automática. Quando o período termina, nada é cobrado e nada some: o app continua funcionando no plano gratuito, com todos os seus lançamentos no lugar. Se quiser manter os recursos Premium, é uma compra única de R$ 29,90.',
  ...
  en: {
    ...
    'hero.authority': "It's not an estimate: it's your card's real closing-day arithmetic.",
    'hero.stakes': "The installment you forgot is already on next month's bill.",
    'hero.microcopy': 'Free to download · No sign-up · We never connect to your bank',
    'hero.transitional': 'Still deciding? See what installments really cost →',
    ...
    'how.subtitle': 'From your first installment to full control in three steps.',
    'how.step1.title': 'Add one installment',
    'how.step1.desc': 'Store, amount and how many months. The card is created right there — no separate form.',
    'how.step2.title': 'See your upcoming bills',
    'how.step2.desc': "Know today what you'll pay over the next 12 months, with every installment already counted.",
    'how.step3.title': 'Get told before the heavy month',
    'how.step3.desc': 'Closing date, due date, a big installment landing: MeuGrana tells you before, not after.',
    ...
    'pricing.premium.name': 'Premium',
    'pricing.premium.price': 'One-time payment of R$ 29.90',
    ...
    'faq.q1.a': 'Yes, MeuGrana is free to download and use. The free plan includes the monthly dashboard, transaction logging and installment tracking. Premium unlocks unlimited cards and installments, 12-month projection, custom categories, reports, CSV export and extra widgets — a one-time payment of R$ 29.90 (lifetime access).',
    'faq.q13.q': 'Is there a free trial of Premium?',
    'faq.q13.a': "There is. When you add your first installment or card, 7 days of Premium unlock — no credit card, no charge, no auto-renewal. When it ends nothing is billed and nothing disappears: the app keeps working on the free plan with all your entries intact. If you want to keep the Premium features, it's a one-time R$ 29.90 purchase.",
    'faq.q8.q': 'Is Premium a subscription? Do I have to cancel it later?',
    'faq.q8.a': "It's not a subscription. MeuGrana Premium is a one-time R$ 29.90 App Store purchase: you pay once, access is for life, and there's nothing to cancel later. Older versions of the app did offer monthly and annual plans — anyone who subscribed back then keeps their access and can cancel anytime in Settings → your name → Subscriptions.",
    ...
    'faq.q29.a': "They're broader apps, with bank connections and subscription pricing — and they serve people who want that well. MeuGrana was built around one specific problem: instalments. It projects each card's bill for the next 12 months, never asks for bank access, works offline and costs a one-time R$ 29.90 instead of a monthly fee. If you want your bank statement imported automatically, they do it better; if you want to know how much of your next bills is already committed, MeuGrana does.",
