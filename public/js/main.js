...
const translations = {
  pt: {
    ...
    'pricing.premium.note': 'Compra única pela App Store — acesso vitalício, sem mensalidade. Planos mensal e anual também disponíveis no app.',
    ...
    'faq.q8.q': 'O Premium é assinatura? Como cancelo?',
    'faq.q8.a': 'Não precisa ser: o Premium pode ser comprado com pagamento único de R$ 19,90 (acesso vitalício), sem mensalidade. Se você optar pelo plano mensal ou anual, a assinatura é gerenciada pela Apple — cancele a qualquer momento em Ajustes → seu nome → Assinaturas, sem multa.',
  ...
  en: {
    ...
    'pricing.premium.note': 'One-time App Store purchase — lifetime access, no monthly fee. Monthly and annual plans also available in the app.',
    ...
    'faq.q8.q': 'Is Premium a subscription? How do I cancel?',
    'faq.q8.a': 'It doesn\'t have to be: Premium can be bought with a one-time payment of R$ 19.90 (lifetime access), no monthly fee. If you choose the monthly or annual plan, the subscription is managed by Apple — cancel anytime in Settings → your name → Subscriptions, with no penalty.',
